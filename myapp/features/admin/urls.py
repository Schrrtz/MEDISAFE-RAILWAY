...
urlpatterns = [
    ...
    path('api/admin/batch-delete-notifications/', dashboard_views.batch_delete_notifications, name='batch_delete_notifications'),
    ...
    path('api/download-password-reset-file/<int:notification_id>/', user_views.download_password_reset_file, name='download_password_reset_file'),
    ...
    path('manage/accounts/restore/<str:user_id>/', account_views.restore_deleted_account, name='restore_deleted_account'),
    path('manage/accounts/permanent-delete/', user_views.permanent_delete_account, name='permanent_delete_account'),
    ...
    path('mod_doctors/convert/<int:doctor_id>/', doctor_views.convert_doctor_to_patient, name='convert_doctor_to_patient'),
